          ...
          <el-form-item class="input" label="客车类型" prop="kecheleixing">
              <el-input v-model="ruleForm.kecheleixing" 
                placeholder="客车类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客车价格" prop="kechejiage">
          <el-input v-model="ruleForm.kechejiage" 
              placeholder="客车价格" clearable  :readonly="ro.kechejiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客车价格" prop="kechejiage">
              <el-input v-model="ruleForm.kechejiage" 
                placeholder="客车价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="核载人数" prop="hezairenshu">
          <el-input v-model="ruleForm.hezairenshu" 
              placeholder="核载人数" clearable  :readonly="ro.hezairenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="核载人数" prop="hezairenshu">
              <el-input v-model="ruleForm.hezairenshu" 
                placeholder="核载人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  data() {
	...
	hezairenshu : false,
            ...
            ruleForm: {
                  ...
                  kecheleixing: [
                            { required: true, message: '客车类型不能为空', trigger: 'blur' },
                                    	                                                              ],
                  kechejiage: [
                                    	                                                              ],
                  hezairenshu: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kecheleixing = true;
            continue;
	            	            ...
	            	            if(o=='kechejiage'){
            this.ruleForm.kechejiage = obj[o];
	    this.ro.kechejiage = true;
            continue;
          }
	            	            if(o=='hezairenshu'){
            this.ruleForm.hezairenshu = obj[o];
	    this.ro.hezairenshu = true;
            continue;
          }
	                    }
                                                                                                                                                                              }
