  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出发日期" prop="chufariqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chufariqi" label="出发日期" prop="chufariqi">
          ...
          <el-form-item class="input" label="起点" prop="qidian">
              <el-input v-model="ruleForm.qidian" 
                placeholder="起点" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="途经" prop="tujing">
          <el-input v-model="ruleForm.tujing" 
              placeholder="途经" clearable  :readonly="ro.tujing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="途经" prop="tujing">
              <el-input v-model="ruleForm.tujing" 
                placeholder="途经" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    zhanghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
                                                                                                                                                                                                                                                                                                            if(data.data.kechechepaihao){
                this.ruleForm.kechechepaihao = data.data.kechechepaihao
              }
                              } else {
          this.$message.error(data.msg);
        }
