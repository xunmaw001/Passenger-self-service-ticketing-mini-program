          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退票日期" prop="tuipiaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tuipiaoriqi" 
                type="date"
                placeholder="退票日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuipiaoriqi" label="退票日期" prop="tuipiaoriqi">
              <el-input v-model="ruleForm.tuipiaoriqi" 
                placeholder="退票日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tuipiaoyuanyin = true;
            continue;
	            	            ...
	            	            if(o=='tuipiaoriqi'){
            this.ruleForm.tuipiaoriqi = obj[o];
	    this.ro.tuipiaoriqi = true;
            continue;
          }
	            	            if(o=='userid'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tuipiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuipiaoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
